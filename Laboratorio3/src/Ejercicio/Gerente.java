...
public class Gerente extends Empleado
{
    ...
    double salario, int maximoEmpleados, String departamento)
    {
        ...
        if(maximoEmpleados > 0) this.maximoEmpleados = maximoEmpleados;
        else
        {
    ...
    {
        if(nuevoTamaño > 0) maximoEmpleados = nuevoTamaño;
        else System.out.println("No se pudo modificar la cantidad maxima de empleados, ingrese un numero positivo");
    }
    ...
    public void contratar(Empleado empleado)
    {
        ...
        else System.out.println("Se alcanzo el limite de empleo.");
    }

    public void despedirEmpleado(Empleado empleado)
    {
        if(subordinados.contains(empleado)) subordinados.remove(empleado);
        else System.out.println("El empleado " + empleado.getNombre() + " NO es parte del departamento " + getDepartamento());
    }
    ...
    {
        System.out.println("El gerente " + getNombre() + " está dirigiendo a los empleados del departamento: " + getDepartamento());
        aumentarTrabajoRealizado();
    }
    ...
    public void informe()
    {
        ...
        else System.out.println("No hay empleados en el departamento: " + getDepartamento());
    }
